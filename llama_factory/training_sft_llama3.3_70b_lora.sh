...
job_name=ray_gpt_2412_v1_4096_lora_mix_rank32
task_name=sft
...
# dataset
DATA_NAME=ray_hardcode,ray_chat,ray_knowledge,ray_task,general_chat,general_task,system,pretrain_ray_4096,pretrain_general_4096
RAW_DATA_PATH=/mnt/ceph/licheng/data-text/train_data_20241218/
BIN_DATA_PATH=/mnt/ceph/licheng/data-bin/train_data_20241218_4096/


# config param
model_name=/mnt/ceph/huggingface/Llama-3.3-70B
# model_name=/mnt/ceph/licheng/chat_model/sft/llama3.1_70b/ray_gpt_2411_v1_4096_lora_mix_rank32/epoch/checkpoint-epoch2
