...
BIN_DATA_PATH=/mnt/ceph/licheng/data-bin/train_data_20241218_dpo/


# config param
# model_name=/mnt/ceph/huggingface/Meta-Llama-3.1-8B-Instruct
model_name=/mnt/ceph/licheng/chat_model/sft/llama3.3_70b/ray_gpt_2412_v1_8192_lora_mix_rank32/epoch/checkpoint-epoch3/
