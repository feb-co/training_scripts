...
job_name=ray_gpt_2411_v1_8192_lora_mix_rank32
task_name=sft
...
# dataset
DATA_NAME=ray_chat,ray_task,general_chat,general_task,system,pretrain_ray_8192,pretrain_general_8192
RAW_DATA_PATH=/mnt/ceph/licheng/data-text/train_data_20241112/
BIN_DATA_PATH=/mnt/ceph/licheng/data-bin/train_data_20241112_8192/
