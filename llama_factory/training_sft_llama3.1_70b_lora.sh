...
job_name=ray_gpt_2411_v1_4096_lora_mix_rank32
task_name=sft
...
# dataset
DATA_NAME=ray_chat,ray_task,general_chat,general_task,system,pretrain_ray_4096,pretrain_general_4096
RAW_DATA_PATH=/mnt/ceph/licheng/data-text/train_data_20241112/
BIN_DATA_PATH=/mnt/ceph/licheng/data-bin/train_data_20241112_4096/


# config param
model_name=/mnt/ceph/huggingface/Meta-Llama-3.1-70B-Instruct
# model_name=/mnt/ceph/licheng/chat_model/sft/llama3.1_70b/ray_gpt_2410_v1_4096_lora_mix_rank32/epoch/checkpoint-epoch2
